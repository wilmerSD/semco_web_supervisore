...
class CardSwiperProjects extends StatelessWidget {
  final List<Project> projects;
  const CardSwiperProjects({
    super.key,
    ...
    return SizedBox(
      ...
      child: Swiper(
        ...
        control: const SwiperControl(
          iconPrevious: Bootstrap.arrow_left_circle_fill,
          iconNext: Bootstrap.arrow_right_circle_fill,
          color: AppColors.primaryConst, // color de las flechas
          padding: EdgeInsets.all(8.0), // espacio desde los bordes
