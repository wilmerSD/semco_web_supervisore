...
class HorizontalProjectsList extends StatelessWidget {
  const HorizontalProjectsList({super.key});

  @override
  Widget build(BuildContext context) {
    final projectProvider =
        Provider.of<ProjectProviderP>(context, listen: true);

    return projectProvider.isGettingListProjects
        ? const Center(child: CircularProgressIndicator())
        : projectProvider.listProjects.isEmpty
            ? const Center(
                child: Text('No hay proyectos con el filtro seleccionado'),
              )
            : ListView.builder(
                scrollDirection: Axis.horizontal,
                itemCount: projectProvider.listProjects.length,
                itemBuilder: (context, index) {
                  final project = projectProvider.listProjects[index];
                  return InkWell(
