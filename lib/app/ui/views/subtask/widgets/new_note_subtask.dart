...
class NewNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget noteInput = FieldForm(
        ...
        textEditingController: subtaskProvider.ctrlNoteText);
    Widget dateOfControlInput = InputPrimary(
      readOnly: true,
      hintText: "dd/mm/aaaa",
      label: "Fecha de control:",
      maxLength: 10,
      textEditingController: subtaskProvider.dateOfControlText,
      onChanged: (value) {
        subtaskProvider.dateOfControlText.value;
      },
      inputFormats: [
                        ...
                        SizedBox(
                          ...
                          child: CupertinoDatePicker(
                            ...
                            onDateTimeChanged: (DateTime newDate) {
                              subtaskProvider.dateOfControl = newDate;
                            },
                          ),
                        ),
                        CupertinoButton(
                          ...
                          onPressed: () {
                            ...
                            subtaskProvider.dateOfControlText.text =
                                Helpers.dateToStringTimeDMY(
                                    subtaskProvider.dateOfControl);
                          },
                        ),
                      ],
                    ),
    ...
    Widget typeNote = DropdownButton<String>(
      isExpanded: true,
      value: subtaskProvider.typeNoteSelected,
      icon: Row(
        children: [
      ...
      onChanged: (String? value) {
        subtaskProvider.updateTypeNoteSelected(value);
      },
      items: subtaskProvider.listTypeNote
      ...
      children: [
        ...
        SaveCancelButtons(onSave: () async {
          await subtaskProvider.postProcCreateNote(
            pComeComentario: subtaskProvider.ctrlNoteText.text,
            privateOrPublicNote: subtaskProvider.typeNoteSelected,
            pDateOfControl: subtaskProvider.dateOfControlText.text,
          );
          subtaskProvider.ctrlNoteText.clear();
          subtaskProvider.typeNoteSelected = 'Privado';
          subtaskProvider.dateOfControlText.text = Helpers.dateToStringTimeDMY(subtaskProvider.dateOfControl);
